...
xcopy D:\vue\theta\src\views\*.vue C:\theta-backup\front\src\views\ /E

copy D:\vue\theta\src\components\*.vue C:\theta-backup\front\src\components\

xcopy D:\vue\theta\src\*.js C:\theta-backup\front\src\ /E

xcopy D:\vue\theta\src\assets\*.* C:\theta-backup\front\src\assets\ /E

copy C:\vue\theta\server\*.*  C:\theta-backup\server\
xcopy C:\vue\theta\server\*.py C:\theta-backup\server\ /E
